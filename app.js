...
App({
  ...
  globalData: {
    ...
    // hotunsalableURL: 'https://a95oyxv7s6.execute-api.cn-northwest-1.amazonaws.com.cn/proc/report/usmile/ranking/sales-test',//热销滞销

    /**演示环境 */
    // shopURL: '', //店铺 Contact 刘益

    /**生产环境 */
    shopURL: 'https://petro-midware.esmart365.com', //店铺 Contact 刘益 中间库
